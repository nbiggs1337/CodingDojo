...
class User():
    ...
    def create_user(cls, data):
        ...
        connection = connectToMySQL('registrations')
        query = 'INSERT INTO registrations (first_name, last_name, email, password, created_at, updated_at) VALUES (%(first_name)s, %(last_name)s, %(email)s, %(hashed_pw)s, NOW(), NOW());'
