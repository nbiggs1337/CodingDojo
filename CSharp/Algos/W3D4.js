...
// Write a function for your BST that returns how tall (the length of the longest running branch) your tree is
    ...
    // BST Remove
    // Given a value to remove, find it and remove it from the Binary Search Tree. 
    //If the value is not in the tree, return this or false
